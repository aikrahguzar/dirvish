...
(defcustom dirvish-used-mode-line-segments
  '(sort omit symlink index)
  "List of used mode line SEGMENTs.
...
(defun dirvish--check-deps ()
  ...
  (cl-loop
   with feat-reqs = (append dirvish-preview-dispatchers)
